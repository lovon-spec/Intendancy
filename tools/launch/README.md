...
| Listing policy 2.2 PDF, wrapped (`meta-evidence/listing-policy-2.2.pdf`) | `bafybeiejdchwmf7wqiw3s3t6ubedgcolrcwv3malu45wlwc3twg7ucqcie` | 2 blocks, 164394 bytes | pinned 2026-09-07; the production policy, served by the Kleros CDN |
| Registration MetaEvidence, wrapped | `bafybeifcbrqdv7nh6d2smr33knp2kcncxaq44rxbwogtp57vnpm6f7ikfq` | pinned 2026-09-07 | `REG_META_EVIDENCE=/ipfs/bafybeifcbrqdv7nh6d2smr33knp2kcncxaq44rxbwogtp57vnpm6f7ikfq/registration-meta-evidence.json` |
| Clearing MetaEvidence, wrapped | `bafybeihnkauoj3okjd5lmgsbow6hrigxvf5yw6dfvmgzpcnwe4x5jjfk3u` | pinned 2026-09-07 | `CLEAR_META_EVIDENCE=/ipfs/bafybeihnkauoj3okjd5lmgsbow6hrigxvf5yw6dfvmgzpcnwe4x5jjfk3u/clearing-meta-evidence.json` |
| Listing policy 2.3 PDF, wrapped (`meta-evidence/listing-policy-2.3.pdf`, rendered with Chromium 148 on Linux over `RENDER_SSH`) | `bafybeihz255ojtcr6kmlo4c6r7o7hgann42uxe74rm5wz6smgu7fanzikm` | pinned 2026-09-08 | policy version 1; NOT on chain until the timelock operation below executes |
| Registration MetaEvidence, version 1, wrapped | `bafybeifhlfq6wtjhmnywfklavuj2jr57nyawwfpcepccwgxadisrdjnvce` | pinned 2026-09-08 | `/ipfs/bafybeifhlfq6wtjhmnywfklavuj2jr57nyawwfpcepccwgxadisrdjnvce/registration-meta-evidence.json` |
| Clearing MetaEvidence, version 1, wrapped | `bafybeifgs26pc2yuvt34bs6gjavtg7ke563fov22aoyojs6z6fdckzehm4` | pinned 2026-09-08 | `/ipfs/bafybeifgs26pc2yuvt34bs6gjavtg7ke563fov22aoyojs6z6fdckzehm4/clearing-meta-evidence.json` |
...
## Policy version 1 (policy 2.3): the governance operation

The change is one timelock operation, rehearsed on a Gnosis fork at block 48152064 on 2026-09-08: the Safe calls `schedule` on the timelock with the registry's `changeMetaEvidence(<registration v1>, <clearing v1>)`, no predecessor, salt `0xa6e094043e610ec6d89bbb389f805af4a1320bd1e0c1b18284567d965bf456ee` (keccak of `agent-skills-registry policy 2.3`), delay 604800; operation id `0x8ca3dfb66c4166e3d2ad89657ac9002a5bf1aa51dc0df0fe13284a3255821e2a`. Execution before seven days reverts; afterwards anyone calls `execute` with the same arguments, the registry emits MetaEvidence 2 and 3, `metaEvidenceUpdates` becomes 1, and requests opened earlier keep MetaEvidence 0 and 1. Not scheduled yet: it waits for the CLI's profile migration to ship (a profile that accepts version 1 changes the deployment context of existing installs) and for the owner's word.
