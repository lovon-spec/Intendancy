...
|---|---|---|
| Fill `[SPEC_COMMIT_HASH]`, render the policy to PDF, pin it, the logo and the display bundle, write the three CIDs into both MetaEvidence files | rows 1, 2, 8 | me |
